# tests/schema/test_step3_schema_vs_final_schema.py
...
def test_step3_schema_is_subset_of_final_schema():
    """
    Ensures Step 3 output is structurally compatible with the final solver output.
    """
